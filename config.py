...
OWNER_ID = int(getenv("OWNER_ID", 8167712487))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/smxciupdates")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+x7mHZzJh_vkzNTM1")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://i.ibb.co/spTJ0S6T/x.jpg"
)
PING_IMG_URL = getenv(
